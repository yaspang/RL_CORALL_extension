...
def build_algo_and_env(args):
    ...
    # Convert relative checkpoint path to absolute
    import os
...
def run_one_episode(algo, env_creator, seed, args, capture_history=False, checkpoint=""):
    ...
    # debug: check if episode ended due to max_steps or actual termination
    if step_count >= max_steps:
        print(f"[WARNING] Episode hit max_steps={max_steps} without clean termination (seed={seed})")
