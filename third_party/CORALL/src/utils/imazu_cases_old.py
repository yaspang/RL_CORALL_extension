...
# Increased to 0.55 to position obstacles 55% of original distance (much tighter encounters)
# 0.55 scale means a 6 nmi obstacle becomes ~3.3 nmi, 3.4 nmi becomes ~1.87 nmi
# This creates closer convergence geometry with higher collision probability
GLOBAL_COMPRESSION_SCALE = 0.55
...
def get_obstacle_data(case_number):
    ...
    # Obstacle velocity (18.52 m/s ~10 knots)
