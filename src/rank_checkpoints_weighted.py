"""
Rank all saved checkpoints by safety-focused weighted score (lower = better).

Usage
-----
  python -m src.rank_checkpoints_weighted \\
      --training_dir "GENERALIZED_SB3_YYYYMMDD-HHMMSS" \\
      --quick_eval --sim_time 900.0

Key arguments
-------------
  --training_dir STR       Training output directory containing checkpoints/
  --output_csv STR         Output CSV filename (default: checkpoint_scores.csv)
  --quick_eval             10 seeds/case instead of full 100 (faster)
  --num_seeds INT          Seeds per case (default: 10)
  --checkpoint_stride INT  Evaluate every Nth checkpoint (default: 1)
  --sim_time FLOAT         Episode horizon in seconds (default: 900.0)
  --desired_cross_x_nmi F  Encounter crossing distance in nmi (default: 1.05)
  --target_speed_mps F     Target vessel speed m/s (default: 10.0)
  --ownship_speed_mps F    Ownship speed m/s (default: None = case native)
  --w_collision FLOAT      Collision rate weight (default: 0.50)
  --w_success FLOAT        Success rate weight  (default: 0.30)
  --w_risk FLOAT           Risk exposure weight (default: 0.15)
  --w_sep FLOAT            Separation weight    (default: 0.05)
  --only_steps INT [...]   Evaluate only these specific checkpoint steps
"""
