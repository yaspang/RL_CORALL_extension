"""
Batch-render episode histories from a policy evaluation directory to animated GIFs.

Usage
-----
  python -m src.visualizations.batch_animate_eval \\
      --eval_dir "policy_eval_generalized_sb3_case6_TIMESTAMP/seed_0" \\
      --ship_scale 2.0 --fps 20 --stride 4

Key arguments
-------------
  --eval_dir STR           Path to seed_0/ dir containing episode_histories/ (required)
  --output_dir STR         Output directory for GIFs (default: <eval_dir>/animations)
  --case INT               Case number for reference labelling
  --ship_scale FLOAT       Scale factor for ship icon rendering (default: 2.0)
  --fps INT                Frames per second for output GIF (default: 20)
  --stride INT             Frame stride for downsampling (default: 4)

Outputs
-------
  <output_dir>/episode_<N>_case<C>_seed<S>.gif   One GIF per episode NPZ
"""
...
from src.visualizations.episode_overlay_tools import load_episode_history
